...
class StanfordSentiment:
    ...
    def sentences(self):
        ...
        sentences = []
        with codecs.open(self.path + "/datasetSentences.txt", "r", encoding='utf-8-sig') as f:
            first = True
            for line in f:
                if first:
                    first = False
    ...
    def sent_labels(self):
        ...
        dictionary = dict()
        phrases = 0
        with open(self.path + "/dictionary.txt", "r", encoding='utf-8-sig') as f:
            for line in f:
                line = line.strip()
        ...
        labels = [0.0] * phrases
        with open(self.path + "/sentiment_labels.txt", "r", encoding='utf-8-sig') as f:
            first = True
            for line in f:
                if first:
                    first = False
    ...
    def dataset_split(self):
        ...
        with open(self.path + "/datasetSplit.txt", "r", encoding='utf-8-sig') as f:
            first = True
            for line in f:
                if first:
                    first = False
