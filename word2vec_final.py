...
from word2vec_evolution import *
from sgd import *

import _pickle as pickle # " import cPickle as pickle "  orginal code is work on python 2, instead using this
from utils.treebank import *   # use next layer modul, which is the function about processing original data
...
wordVectors0 = sgd(
    lambda vec: word2vec_sgd(skipgram, tokens, vec, dataset, C, 
